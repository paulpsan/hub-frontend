...
@Component({
  selector: "hub-admin-usuarios-proyecto",
  templateUrl: "./admin-usuarios-proyecto.component.html",
  styleUrls: ["./admin-usuarios-proyecto.component.css"]
})
export class AdminUsuariosProyectoComponent implements OnInit {
  id: any;
  userForm: FormGroup;
  proyecto;
  usuario;
