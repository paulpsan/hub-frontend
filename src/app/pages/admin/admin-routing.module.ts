...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: "institucion/grupos/usuarios/:id", component: UsuariosGrupoComponent },
      { path: "institucion/grupos/proyectos/:id", component: ProyectosGrupoComponent },
      { path: "institucion/grupos/proyectos/usuarios/:id", component: UsuariosProyectoComponent }
    ]
  },
  // {
  //   path: "institucion",
